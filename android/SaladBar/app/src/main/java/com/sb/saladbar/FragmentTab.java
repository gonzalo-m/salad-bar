...
//        int imagesKey = getArguments().getInt("ingredients");
//        TypedArray tArray = getResources().obtainTypedArray(imagesKey);
...
//        Ingredient[] ingredients = getArguments().getSerializable("ingredients");
//        imgs = new int[tArray.length()];
//        for (int i = 0; i < imgs.length; i++) {
//            Ingredient ingredient = tArray.get(i);
//            imgs[i] = tArray.getResourceId(i, 0);
//        }
    }
