...
public enum Topping implements Ingredient {
    ...
    RAW_PECANS("Pecans", .25, 100, R.drawable.topping_raw_pecan),
    ...
    ROASTED_SWEET_POTATO("Sweet Potato", .25, 70, R.drawable.topping_roasted_sweet_potato),
    ...
    SPICY_QUINOA("Quinoa", .25, 50, R.drawable.topping_spicy_quinoa),
    ...
    TOASTED_ALMONDS("Almonds", .25, 80, R.drawable.topping_toasted_almonds),
